...
function FAQ() {
  const faqs: [string, string][] = [
    ...
    ["Should I bring a laptop?", "Yes, please bring a laptop if you can — a lot of the session is hands-on, and you'll get the most out of it by practising live in the room."],
